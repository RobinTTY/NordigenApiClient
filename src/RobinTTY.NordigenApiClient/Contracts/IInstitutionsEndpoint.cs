...
public interface IInstitutionsEndpoint
{
    ...
    /// If set to true, filters institutions by whether private accounts are supported.
    /// </param>
    /// <param name="readRefundAccountSupported">
    /// If set to true, filters institutions by whether a read refund account is supported.
    /// </param>
    ...
    /// </param>
    /// <param name="separateContinuousHistoryConsentSupported">
