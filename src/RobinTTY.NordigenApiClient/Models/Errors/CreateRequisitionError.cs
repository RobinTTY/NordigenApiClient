...
public class CreateRequisitionError : BasicError
{
    ...
    /// <param name="referenceError">An error that was returned related to the <see cref="CreateRequisitionRequest.Reference"/> property sent during the request.</param>
    /// <param name="userLanguageError">An error that was returned related to the <see cref="CreateRequisitionRequest.UserLanguage"/> property sent during the request.</param>
    /// <param name="agreementError">An error that was returned related to the <see cref="CreateRequisitionRequest.AgreementId"/> property sent during the request.</param>
    /// <param name="redirectError">An error that was returned related to the <see cref="CreateRequisitionRequest.Redirect"/> property sent during the request.</param>
    /// <param name="socialSecurityNumberError">An error that was returned related to the <see cref="CreateRequisitionRequest.SocialSecurityNumber"/> property sent during the request.</param>
