...
/// <para>Reference: <a href="https://developer.gocardless.com/bank-account-data/balance#balance_type">GoCardless documentation</a></para>
/// </summary>
...
public enum BalanceType
{
    ...
    /// <summary>
    /// Balance of the account at the previously closed account reporting period. The opening booked balance for the new period has to be equal to this
    /// balance. Usage: the previously booked closing balance should equal (inclusive date) the booked closing balance of the date it references and equal
