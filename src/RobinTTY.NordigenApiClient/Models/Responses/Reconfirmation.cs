...
public class Reconfirmation
{
    ...
    public Reconfirmation(Uri reconfirmationUrl, DateTime created, DateTime urlValidFrom, DateTime urlValidTo, DateTime? lastAccessed, DateTime? lastSubmitted, Uri redirectUrl)
    {
