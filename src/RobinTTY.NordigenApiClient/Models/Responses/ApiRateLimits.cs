...
/// <para>
/// The rate limits can be negative if a request fails due to validation errors before being sent to the API
/// (e.g., no secretId/secretKey provided). So no actual
/// API request was performed and no rate limits can be returned.
/// </para>
/// </summary>
