...
public enum CashAccountType
{
    ...
    Taxes,
    /// <summary>
    /// A transacting account is the most basic type of bank account that you can get. The main difference between transaction and check accounts is
    /// that you usually do not get a checkbook with your transacting account and neither are you offered an overdraft facility.
    /// </summary>
    [Description("TRAN")]
    Transacting,
    /// <summary>
