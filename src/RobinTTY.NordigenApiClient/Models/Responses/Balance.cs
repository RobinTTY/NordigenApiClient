...
public class Balance
{
    ...
    /// <summary>
    /// A flag indicating if the credit limit of the corresponding account is included in the calculation of the balance,
    /// where applicable.
    /// </summary>
    ...
    /// <summary>
    /// This data element might be used to indicate e.g. with the expected or booked balance that no action is known on the
    /// account, which is not yet booked.
    /// </summary>
    [JsonPropertyName("lastChangeDateTime")]
    public DateTime? LastChangeDateTime { get; }

    /// <summary>
    /// Entry reference of the last committed transaction to support the TPP in identifying whether all end users
    ...
    /// <param name="creditLimitIncluded">
    /// A flag indicating if the credit limit of the corresponding account is included in the
    /// calculation of the balance, where applicable.
    /// </param>
    /// <param name="lastChangeDateTime">
    /// This data element might be used to indicate e.g. with the expected or booked balance
    /// that no action is known on the account, which is not yet booked.
    /// </param>
    /// <param name="lastCommittedTransaction">
    /// Entry reference of the last committed transaction to support the TPP in
    /// identifying whether all end users transactions are already known.
    /// </param>
    [JsonConstructor]
