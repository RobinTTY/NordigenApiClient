...
/// <para>
/// Reference:
/// <a href="https://developer.gocardless.com/bank-account-data/transactions">GoCardless Documentation</a>
/// </para>
/// </summary>
public class Transaction
{
    ...
    /// <para>
    ///     <b>Limited by the PSD2 specification to 140 characters, truncates additional information if necessary.</b>
    /// </para>
    /// </summary>
    ...
    /// <para>
    ///     <b>
    ///     Might contain more information than <see cref="RemittanceInformationUnstructured" /> (if contents were
    ///     truncated).
    ///     </b>
    /// </para>
    /// </summary>
    ...
    /// The reference
    /// helps the seller to assign an incoming payment to the invoice by using a reference such as the invoice number or a
    ...
    /// Used as access-ID in the PSD2 interface, where more details on an transaction are offered. If this data
    /// attribute is provided this shows that the AIS (Account Information Service) can get access on more details about
    /// this transaction.
    /// </param>
    ...
    /// The transaction amount including details about the currency the amount is denominated
    /// in.
    /// </param>
    ...
    /// available to the account owner in case of a debit entry.
    /// </param>
    /// <param name="remittanceInformationUnstructured">
    /// Unstructured reference issued by the seller used to establish a link between the payment of an invoice
    /// and the invoice instance. The reference helps the seller to assign an incoming payment to the invoice by
    /// using a reference such as the invoice number or a purchase order number.
    /// <para>
    ...
    /// </para>
    /// </param>
    /// <param name="remittanceInformationUnstructuredArray">
    /// Unstructured reference issued by the seller used to establish a link between the payment of an invoice
    /// and the invoice instance. The reference helps the seller to assign an incoming payment to the invoice by
    /// using a reference such as the invoice number or a purchase order number.
    /// <para>
    ...
    /// Date at which assets become available to the account owner in case of a credit entry, or
    /// cease to be available to the account owner in case of a debit entry.
    /// </param>
    /// <param name="remittanceInformationStructured">
    /// Reference issued by the seller used to establish a link between the
    /// payment of an invoice and the invoice instance. The reference helps the seller to assign an incoming payment to the
    /// invoice by using a reference such as the invoice number or a purchase order number.
    /// </param>
    ...
    /// Used by the financial institution to transport additional transaction related
    /// information.
    /// </param>
