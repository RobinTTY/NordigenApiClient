...
/// <summary>
/// Represents the JWT token pair returned by the GoCardless API.
/// </summary>
public class JsonWebTokenPair
{
    ...
    /// </summary>
    /// <param name="accessToken">The GoCardless access token to use.</param>
    /// <param name="refreshToken">The GoCardless refresh token to use.</param>
