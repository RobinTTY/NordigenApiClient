...
public class AgreementsEndpoint
{
    ...
    {
        var body = JsonContent.Create(agreement, _nordigenClient.JsonContext.CreateAgreementRequest);
    ...
    {
        var body = JsonContent.Create(metadata, _nordigenClient.JsonContext.AcceptAgreementRequest);
        return await _nordigenClient.MakeRequest<Agreement, BasicError>(
