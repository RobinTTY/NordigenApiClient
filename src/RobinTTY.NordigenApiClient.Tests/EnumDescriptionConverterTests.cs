...
internal class EnumDescriptionConverterTests
{
    ...
    [TestCase("closingAvailable", BalanceType.ClosingAvailable)]
    ...
    [TestCase("information", BalanceType.Information)]
    [TestCase("interimAvailable", BalanceType.InterimAvailable)]
    [TestCase("interimBooked", BalanceType.InterimBooked)]
    [TestCase("nonInvoiced", BalanceType.NonInvoiced)]
    [TestCase("previouslyClosedBooked", BalanceType.PreviouslyClosedBooked)]
    [TestCase("openingBooked", BalanceType.OpeningBooked)]
    [TestCase("openingAvailable", BalanceType.OpeningAvailable)]
